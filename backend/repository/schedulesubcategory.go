...
// 資産情報の作成
func CreateScheduleSubcategory(category *models.ScheduleSubcategory) error {
...
// 資産情報の更新
func UpdateScheduleSubcategory(subcategory *models.ScheduleSubcategory) error {
...
// 重複チェック用
func CheckScheduleSubcategoryConflicting(subcategory *models.ScheduleSubcategory) int64 {
...
// 更新チェック用
func CheckScheduleSubcategoryUpdate(subcategoryID int, updateTime time.Time) int64 {
